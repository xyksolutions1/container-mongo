...
LABEL \
        ...
        org.opencontainers.image.url="https://hub.docker.com/r/xyksolutions1/mongodb" \
        org.opencontainers.image.documentation="https://github.com/xyksolutions1/container-mongodb/blob/main/README.md" \
        org.opencontainers.image.source="https://github.com/xyksolutions1/container-mongodb.git" \
        org.opencontainers.image.authors="xyksolutions1" \
        org.opencontainers.image.vendor="xyksolutions1" \
        org.opencontainers.image.licenses="MIT"

ARG \
    MONGO_VERSION="r7.0.29" \
    MONGO_REPO_URL="https://github.com/mongodb/mongo" \
    MONGOSHELL_VERSION="2.6.0" \
...
ENV \
    ...
    IMAGE_NAME="xyksolutions1/mongo" \
    IMAGE_REPO_URL="https://github.com/xyksolutions1/container-mongo/"
